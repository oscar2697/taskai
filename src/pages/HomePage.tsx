...
const HomePage = () => {
    return (
        <>
            <Head 
                title="Task AI - AI Powered Task Manager To-Do List  & Project Management App"
            />
                ...
                <div className="container !px-8 grid grid-cols-1 gap-8 items-center xl:gap-12 xl:grid-cols-[1fr_1.5fr]">
                    <div className="flex flex-col items-center text-center space-y-4 lg:text-left lg:items-start lg:space-y-6">
                        <h1 className="text-4xl font-semibold max-w-[22ch] md:text-5xl lg:text-6xl xl:text-5xl 2xl:text-6xl">
                            ...
                            <span className="inline-flex bg-gradient-to-t from-primary/50 to-primary/30 rounded-full px-2 overflow-hidden">Task AI -</span>  Your AI-Powered Task Manager
                        </h1>

                        <p className="max-w-[48ch] text-foreground/80 md:text-lg lg:text-xl">
                            Simplify your life with Task AI, the ultimate AI-powered task manager.
                        </p>
                    ...
                    <figure className="bg-secondary rounded-2xl overflow-hidden aspect-square max-md_max-w-[480px] max-md:mx-auto md:aspect-video">
                        <img 
                            src={heroBannerSm}
                            width={480}
                            height={480}
