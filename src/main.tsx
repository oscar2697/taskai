...
const SIGN_IN_FORCE_URL = import.meta.env.VITE_CLERK_SIGN_IN_FORCE_REDIRECT_URL
const SIGN_UP_FORCE_URL = import.meta.env.VITE_CLERK_SIGN_UP_FORCE_REDIRECT_URL
...
createRoot(document.getElementById('root')!).render(
  <StrictMode>
    <ClerkProvider
      ...
      signInForceRedirectUrl={SIGN_IN_FORCE_URL}
      signUpForceRedirectUrl={SIGN_UP_FORCE_URL}
      appearance={{
